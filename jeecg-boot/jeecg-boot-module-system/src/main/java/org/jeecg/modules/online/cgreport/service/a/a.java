...
public class a implements CgReportExcelServiceI {
   ...
   private HSSFCellStyle a(HSSFWorkbook var1) {
      ...
      var2.setBorderLeft(BorderStyle.THIN);
      var2.setBorderRight(BorderStyle.THIN);
      var2.setBorderBottom(BorderStyle.THIN);
      var2.setBorderTop(BorderStyle.THIN);
      var2.setAlignment(HorizontalAlignment.CENTER);
      var2.setFillForegroundColor(IndexedColors.GREY_25_PERCENT.getIndex());
   ...
   private HSSFCellStyle b(HSSFWorkbook var1) {
      ...
      var2.setBorderBottom(BorderStyle.THIN);
      var2.setBorderTop(BorderStyle.THIN);
      var2.setFillForegroundColor(IndexedColors.LIGHT_TURQUOISE.index);
      var2.setFillPattern(FillPatternType.SOLID_FOREGROUND);
      return var2;
   }
