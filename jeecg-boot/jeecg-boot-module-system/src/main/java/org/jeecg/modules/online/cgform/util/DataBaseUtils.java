...
public class DataBaseUtils {
    ...
    public static String a(List<OnlCgformField> list, Map<String, Object> map, List<String> list2, List<SysPermissionDataRuleModel> list3) {
        ...
        String string = "";
        try {
            string = DataBaseUtil.getDatabaseType();
        ...
        for (OnlCgformField onlCgformField : list) {
            ...
            if (list2 != null && list2.contains(string2)) {
                ...
                onlCgformField.setQueryMode(QUERY_MODE_SINGLE);
            }
    ...
    private static void a(StringBuilder stringBuilder, QueryRuleEnum queryRuleEnum, String string, String string2, String string3) {
        ...
        switch (queryRuleEnum) {
            ...
            case LIKE: {
                stringBuilder.append(LIKE).append(NEGATIVE).append(z).append("%").append(string).append("%").append(z);
                break;
            }
            case LEFT_LIKE: {
                stringBuilder.append(LIKE).append(NEGATIVE).append(z).append("%").append(string).append(z);
                break;
            }
            case RIGHT_LIKE: {
                stringBuilder.append(LIKE).append(NEGATIVE).append(z).append(string).append("%").append(z);
                break;
            }
            default: {
    ...
    public static JSONObject a(List<OnlCgformField> list, List<String> list2, TablePidModel tablePidModel2) {
        ...
        for (OnlCgformField onlCgformField : list) {
            ...
            } else if (tablePidModel2 != null && dbFieldName.equals(tablePidModel2.getFieldName())) {
                String object5 = tablePidModel2.getTableName() + COMMA + tablePidModel2.getTextField() + COMMA + tablePidModel2.getCodeField();
                TreeSelectProperty treeSelectProperty = new TreeSelectProperty(dbFieldName, dbFieldTxt, object5, tablePidModel2.getPidField(), tablePidModel2.getPidValue());
                treeSelectProperty.setHasChildField(tablePidModel2.getHsaChildField());
    ...
    public static Map<String, Object> a(String string, List<OnlCgformField> list, JSONObject jSONObject) {
        ...
        String string2 = "";
        try {
            string2 = DataBaseUtil.getDatabaseType();
        } catch (SQLException sQLException) {
            sQLException.printStackTrace();
        } catch (DBException dBException) {
            dBException.printStackTrace();
        ...
        if (oConvertUtils.isNotEmpty((Object) string2)) {
            ...
            for (OnlCgformField onlCgformField : list) {
                ...
                for (String string4 : arrstring) {
                    ...
                    list2.add(string3);
                    arrayList.add(new BaseColumn(onlCgformField.getDbFieldTxt(), string3));
                    continue block0;
                }
            }
        }
    ...
    private static String getDatabseType() {
        ...
        try {
            aC = DataBaseUtil.getDatabaseType();
            return aC;
        } catch (Exception exception) {
            exception.printStackTrace();
            return aC;
