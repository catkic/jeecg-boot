...
public class OnlCgreportParam implements Serializable {
   ...
   public boolean equals(Object o) {
      if (o == this) {
         ...
         if (!var2.canEqual(this)) {
            ...
            String var7 = this.getCgrheadId();
            String var8 = var2.getCgrheadId();
            if (var7 == null) {
               if (var8 != null) {
                  return false;
               }
            ...
            label110: {
               String var9 = this.getParamName();
               String var10 = var2.getParamName();
               if (var9 == null) {
                  if (var10 == null) {
                     break label110;
                  }
            ...
            label103: {
               String var11 = this.getParamTxt();
               String var12 = var2.getParamTxt();
               if (var11 == null) {
                  if (var12 == null) {
                     break label103;
                  }
            ...
            String var13 = this.getParamValue();
            String var14 = var2.getParamValue();
            if (var13 == null) {
               if (var14 != null) {
                  return false;
               }
   ...
   public int hashCode() {
      ...
      String var6 = this.getParamName();
      var13 = var13 * 59 + (var6 == null ? 43 : var6.hashCode());
      String var7 = this.getParamTxt();
      var13 = var13 * 59 + (var7 == null ? 43 : var7.hashCode());
      String var8 = this.getParamValue();
