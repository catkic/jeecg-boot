...
implements DbTableHandleI {
    ...
    private String a(ColumnProperty columnProperty2) {
        ...
        if (columnProperty2.getColumnType().equalsIgnoreCase("string")) {
            string = columnProperty2.getColumnName() + " varchar2(" + columnProperty2.getColumnSize() + ")";
        } else if (columnProperty2.getColumnType().equalsIgnoreCase("date")) {
            string = columnProperty2.getColumnName() + " date";
        } else if (columnProperty2.getColumnType().equalsIgnoreCase("int")) {
            string = columnProperty2.getColumnName() + " NUMBER(" + columnProperty2.getColumnSize() + ")";
        } else if (columnProperty2.getColumnType().equalsIgnoreCase("double")) {
            string = columnProperty2.getColumnName() + " NUMBER(" + columnProperty2.getColumnSize() + "," + columnProperty2.getDecimalDigits() + ")";
            ...
            string = columnProperty2.getColumnName() + " CLOB ";
        } else if (columnProperty2.getColumnType().equalsIgnoreCase("blob")) {
            string = columnProperty2.getColumnName() + " BLOB ";
        }
    ...
    private String a(ColumnProperty columnProperty2, ColumnProperty columnProperty3) {
        String string = "";
        String string2 = "";
        String string3 = columnProperty3.getRealDbType();
        if (!columnProperty3.getIsNullable().equals(columnProperty2.getIsNullable())) {
            String string4 = string2 = columnProperty2.getIsNullable().equals("Y") ? "NULL" : "NOT NULL";
        }
        if (columnProperty2.getColumnType().equalsIgnoreCase("string")) {
            if (oConvertUtils.isEmpty((Object)string3) || string3.toLowerCase().indexOf("varchar") < 0) {
                string3 = "varchar2";
            }
            string = columnProperty2.getColumnName() + " " + string3 + "(" + columnProperty2.getColumnSize() + ")" + string2;
        } else if (columnProperty2.getColumnType().equalsIgnoreCase("date")) {
            string = columnProperty2.getColumnName() + " date " + string2;
        } else if (columnProperty2.getColumnType().equalsIgnoreCase("int")) {
            string = columnProperty2.getColumnName() + " NUMBER(" + columnProperty2.getColumnSize() + ") " + string2;
        } else if (columnProperty2.getColumnType().equalsIgnoreCase("double")) {
