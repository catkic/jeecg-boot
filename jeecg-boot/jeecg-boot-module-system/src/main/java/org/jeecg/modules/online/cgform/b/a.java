...
public class a {
   ...
   public Result<?> a(@RequestBody org.jeecg.modules.online.cgform.model.a var1) {
      try {
         ...
         return org.jeecg.modules.online.config.b.d.a(var2) ? Result.error("数据库表[" + var2 + "]已存在,请从数据库导入表单") : this.onlCgformHeadService.addAll(var1);
   ...
   public Result<Map<String, Object>> a(@PathVariable("code") String var1, HttpServletRequest var2) {
      ...
      if (var4 == null) {
         ...
         try {
            ...
            Map var6 = org.jeecg.modules.online.cgform.util.b.a(var2);
   ...
   public Result<?> b(@PathVariable("code") String var1, HttpServletRequest var2) {
      ...
      var4.setResult(org.jeecg.modules.online.cgform.util.b.b(var6));
   ...
   public Result<?> a(@PathVariable("table") String var1, @RequestParam(name = "taskId",required = false) String var2) {
      ...
      var3.setResult(org.jeecg.modules.online.cgform.util.b.b(var7));
   ...
   public Result<String> a(@PathVariable("code") String var1, @RequestBody JSONObject var2, HttpServletRequest var3) {
      ...
      try {
         String var5 = org.jeecg.modules.online.cgform.util.b.a();
         var2.put("id", var5);
         ...
         var4.setMessage("保存失败，" + org.jeecg.modules.online.cgform.util.b.a(var8));
      }
   ...
   public Result<?> a(@PathVariable("code") String var1, @RequestBody JSONObject var2) {
      try {
         ...
         return Result.error("修改失败，" + org.jeecg.modules.online.cgform.util.b.a(var5));
      }
   }
   ...
   public Result<?> h(@PathVariable("code") String var1, @PathVariable("synMethod") String var2) {
      try {
         ...
         return Result.error("同步数据库失败，" + org.jeecg.modules.online.cgform.util.b.a(var5));
      }
   ...
   public Result<?> b(@PathVariable("code") String var1, HttpServletRequest var2, HttpServletResponse var3) {
      ...
      try {
         ...
         List var14 = org.jeecg.modules.online.cgform.util.b.e(var12);
         if (oConvertUtils.isEmpty(var13) && var10.getTableType() == 2 && oConvertUtils.isNotEmpty(var10.getSubTableStr())) {
            ...
            for(int var17 = 0; var17 < var16; ++var17) {
               ...
               if (var19 != null) {
                  ...
                  List var21 = org.jeecg.modules.online.cgform.util.b.b(var20, var19.getTableTxt());
                  if (var21.size() > 0) {
                     var14.addAll(var21);
                  }
               }
         ...
         String var54 = org.jeecg.modules.online.config.b.d.a(var53);
         ...
         while(true) {
            ...
            if ("1".equals(var8) && var9.length() > 0) {
               String var56 = org.jeecg.modules.online.cgform.util.b.a(this.upLoadPath, var10.getTableTxt(), var9);
   ...
   public Object a(OnlCgformHead var1, DataSource var2, String var3) throws SQLException, DBException {
      ...
      if (oConvertUtils.isNotEmpty(var5) && "UUID".equalsIgnoreCase(var5)) {
         var4 = org.jeecg.modules.online.cgform.util.b.a();
      } else {
   ...
   private void a(String var1, Map<String, Object> var2, List<Map<String, Object>> var3, List<ExcelExportEntity> var4) {
      ...
      for(int var15 = 0; var15 < var3.size(); ++var15) {
         ...
         String var12 = org.jeecg.modules.online.cgform.util.b.a(var5.getTableName(), var7, var2);
         ...
         ((Map)var3.get(var15)).put(var1, org.jeecg.modules.online.cgform.util.b.d(var13));
      }
   ...
   public Result<?> i(@RequestParam("tbname") String var1, @RequestParam("id") String var2) {
      ...
      if (oConvertUtils.isEmpty(var2)) {
         if (org.jeecg.modules.online.config.b.d.a(var1)) {
            return Result.ok(-1);
         }
         ...
         if (!var1.equals(var3.getTableName()) && org.jeecg.modules.online.config.b.d.a(var1)) {
            return Result.ok(-1);
         }
      }
   ...
   public Result<Map<String, Object>> d(@PathVariable("code") String var1, HttpServletRequest var2) {
      ...
      if (var4 == null) {
         ...
         try {
            ...
            Map var9 = org.jeecg.modules.online.cgform.util.b.a(var2);
            String var10 = null;
   ...
   public Result<?> b(@PathVariable("name") String var1, @RequestBody JSONObject var2) {
      ...
      try {
         String var4 = org.jeecg.modules.online.cgform.util.b.a();
         var2.put("id", var4);
