...
implements IOnlCgformFieldService {
    ...
    public Map<String, Object> queryAutolistPage(String tbname, String headId, Map<String, Object> params, List<String> needList) {
        ...
        org.jeecg.modules.online.cgform.util.b.a(tbname, list2, stringBuffer);
        ...
        String string2 = org.jeecg.modules.online.cgform.util.b.a(list, params, needList, list3);
        String string3 = org.jeecg.modules.online.cgform.util.b.a(params);
        stringBuffer.append(" where 1=1  " + string2 + string3);
        Object object3 = params.get("column");
        if (object3 != null) {
            object2 = object3.toString();
            object = params.get("order").toString();
        ...
        if ((Integer)(object2 = Integer.valueOf(params.get("pageSize") == null ? 10 : Integer.parseInt(params.get("pageSize").toString()))) == -521) {
            object = this.onlCgformFieldMapper.queryListBySql(stringBuffer.toString());
            ...
            if (object == null || object.size() == 0) {
                ...
                hashMap.put("fieldList", list2);
                hashMap.put("records", org.jeecg.modules.online.cgform.util.b.d((List<Map<String, Object>>)object));
            }
        } else {
            object = params.get("pageNo") == null ? 1 : Integer.parseInt(params.get("pageNo").toString());
            Page page = new Page((long)((Integer)object).intValue(), (long)((Integer)object2).intValue());
            ...
            hashMap.put("records", org.jeecg.modules.online.cgform.util.b.d(iPage.getRecords()));
        }
        return hashMap;
    }
    ...
    public Map<String, Object> queryAutoTreeNoPage(String tbname, String headId, Map<String, Object> params, List<String> needList, String pidField) {
        ...
        if (object2 != null) {
            ...
            arrayList = params.get("order").toString();
        ...
        if ((Integer)(object = Integer.valueOf(params.get("pageSize") == null ? 10 : Integer.parseInt(params.get("pageSize").toString()))) == -521) {
            arrayList = this.onlCgformFieldMapper.queryListBySql(stringBuffer.toString());
            ...
            if (arrayList == null || arrayList.size() == 0) {
                ...
                hashMap.put("fieldList", list2);
                hashMap.put("records", org.jeecg.modules.online.cgform.util.b.d(arrayList));
            }
        } else {
            arrayList = params.get("pageNo") == null ? 1 : Integer.parseInt(params.get("pageNo").toString());
    ...
    private Map<String, Object> a(String string, String string2, String string3, List<String> list, String string4) {
        ...
        StringBuffer stringBuffer = new StringBuffer();
        org.jeecg.modules.online.cgform.util.b.a(string2, list3, stringBuffer);
        LoginUser loginUser = (LoginUser)SecurityUtils.getSubject().getPrincipal();
        ...
        String string6 = org.jeecg.modules.online.cgform.util.b.a(list2, hashMap, list, list4);
    ...
    public void saveFormData(String code, String tbname, JSONObject json, boolean isCrazy) {
        ...
        List list = this.list((Wrapper)lambdaQueryWrapper);
        if (isCrazy) {
            ((OnlCgformFieldMapper)this.baseMapper).executeInsertSQL(org.jeecg.modules.online.cgform.util.b.c(tbname, list, json));
        } else {
            ((OnlCgformFieldMapper)this.baseMapper).executeInsertSQL(org.jeecg.modules.online.cgform.util.b.a(tbname, (List<OnlCgformField>)list, json));
        }
    }
    ...
    public void saveTreeFormData(String code, String tbname, JSONObject json, String hasChildField, String pidField) {
        ...
        Map<String, Object> map = org.jeecg.modules.online.cgform.util.b.a(tbname, (List<OnlCgformField>)list, json);
    ...
    public void saveFormData(List<OnlCgformField> fieldList, String tbname, JSONObject json) {
        Map<String, Object> map = org.jeecg.modules.online.cgform.util.b.a(tbname, fieldList, json);
        ((OnlCgformFieldMapper)this.baseMapper).executeInsertSQL(map);
    }
    ...
    public void editFormData(String code, String tbname, JSONObject json, boolean isCrazy) {
        ...
        List list = this.list((Wrapper)lambdaQueryWrapper);
        if (isCrazy) {
            ((OnlCgformFieldMapper)this.baseMapper).executeUpdatetSQL(org.jeecg.modules.online.cgform.util.b.d(tbname, list, json));
        } else {
            ((OnlCgformFieldMapper)this.baseMapper).executeUpdatetSQL(org.jeecg.modules.online.cgform.util.b.b(tbname, list, json));
        }
    }

    @Override
    public void editTreeFormData(String code, String tbname, JSONObject json, String hasChildField, String pidField) {
        String string = org.jeecg.modules.online.cgform.util.b.f(tbname);
        ...
        for (Object object : list) {
            if (!pidField.equals(((OnlCgformField)object).getDbFieldName()) || !oConvertUtils.isEmpty((Object)json.get((Object)pidField))) continue;
            ((OnlCgformField)object).setIsShowForm(1);
            json.put(pidField, (Object)b);
        }
        Map<String, Object> map3 = org.jeecg.modules.online.cgform.util.b.b(tbname, list, json);
    ...
    public Map<String, Object> queryFormData(String code, String tbname, String id) {
        ...
        List list = this.list((Wrapper)lambdaQueryWrapper);
        String string = org.jeecg.modules.online.cgform.util.b.a(tbname, (List<OnlCgformField>)list, id);
        ...
        if (head.getTableType() == 2) {
            ...
            if (oConvertUtils.isNotEmpty((Object)head.getSubTableStr())) {
                ...
                for (String string7 : arrstring) {
                    object = org.jeecg.modules.online.cgform.util.b.a(string2, (List<OnlCgformField>)list, string7);
    ...
    public void deleteAutoList(String tbname, String linkField, String linkValue) {
        if (linkValue != null && !"".equals(linkValue)) {
            ...
            String string2 = "DELETE FROM " + org.jeecg.modules.online.cgform.util.b.f(tbname) + " where " + linkField + " in(" + string.substring(0, string.length() - 1) + ")";
            a.debug("--删除sql-->" + string2);
    ...
    public Map<String, Object> queryFormData(List<OnlCgformField> fieldList, String tbname, String id) {
        String string = org.jeecg.modules.online.cgform.util.b.a(tbname, fieldList, id);
        return this.onlCgformFieldMapper.queryFormData(string);
    }

    @Override
    public List<Map<String, Object>> querySubFormData(List<OnlCgformField> fieldList, String tbname, String linkField, String value) {
        String string = org.jeecg.modules.online.cgform.util.b.a(tbname, fieldList, linkField, value);
    ...
    public void updateTreeNodeNoChild(String tableName, String filed, String id) {
        Map<String, Object> map = org.jeecg.modules.online.cgform.util.b.a(tableName, filed, id);
    ...
    public String queryTreePids(OnlCgformHead head, String ids) {
        ...
        for (String string3 : arrstring = ids.split(",")) {
            ...
            String string4 = org.jeecg.modules.online.cgform.util.b.f(string2);
            ...
            String string7 = "select * from " + org.jeecg.modules.online.cgform.util.b.f(string2) + " where " + string + "= '" + string6 + "' and id not in(" + ids + ")";
            List<Map<String, Object>> list = this.onlCgformFieldMapper.queryListBySql(string7);
            if (list != null && list.size() != 0 || Arrays.asList(arrstring).contains(string6) || stringBuffer.toString().contains(string6)) continue;
    ...
    private StringBuffer a(String string, String string2, String string3, StringBuffer stringBuffer) {
        String string4 = "select * from " + org.jeecg.modules.online.cgform.util.b.f(string3) + " where " + string2 + "= '" + string + "'";
    ...
    private static /* synthetic */ Object a(SerializedLambda serializedLambda) {
        switch (serializedLambda.getImplMethodName()) {
            ...
            case "getIsShowForm": {
                if (serializedLambda.getImplMethodKind() == 5 && serializedLambda.getFunctionalInterfaceClass().equals("com/baomidou/mybatisplus/core/toolkit/support/SFunction") && serializedLambda.getFunctionalInterfaceMethodName().equals("apply") && serializedLambda.getFunctionalInterfaceMethodSignature().equals("(Ljava/lang/Object;)Ljava/lang/Object;") && serializedLambda.getImplClass().equals("org/jeecg/modules/online/cgform/entity/OnlCgformField") && serializedLambda.getImplMethodSignature().equals("()Ljava/lang/Integer;")) {
                    return OnlCgformField::getIsShowForm;
                }
                if (serializedLambda.getImplMethodKind() == 5 && serializedLambda.getFunctionalInterfaceClass().equals("com/baomidou/mybatisplus/core/toolkit/support/SFunction") && serializedLambda.getFunctionalInterfaceMethodName().equals("apply") && serializedLambda.getFunctionalInterfaceMethodSignature().equals("(Ljava/lang/Object;)Ljava/lang/Object;") && serializedLambda.getImplClass().equals("org/jeecg/modules/online/cgform/entity/OnlCgformField") && serializedLambda.getImplMethodSignature().equals("()Ljava/lang/Integer;")) {
                    return OnlCgformField::getIsShowForm;
                }
