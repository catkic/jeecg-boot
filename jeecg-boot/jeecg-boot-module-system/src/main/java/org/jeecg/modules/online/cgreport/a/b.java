...
public class b {
   ...
   public Result<?> a(@RequestParam(name = "sql") String var1, @RequestParam(name = "dbKey",required = false) String var2) {
      ...
      try {
         ...
         for(var15 = var6.iterator(); var15.hasNext(); ++var8) {
            ...
            var11.setId(org.jeecg.modules.online.cgform.util.b.a());
   ...
   @PostMapping({"/add"})
   public Result<?> a(@RequestBody OnlCgreportModel var1) {
      Result var2 = new Result();

      try {
         String var3 = org.jeecg.modules.online.cgform.util.b.a();
